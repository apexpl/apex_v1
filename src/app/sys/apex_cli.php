...
{ 
    ...
    // Remote Access
    $response .= "\tREMOTE ACCESS CLIENT\n";
    $response .= str_pad('remote_update_apikey', 40) . "Define the remote access host and API key.\n";
    $response .= str_pad('remote_copy [FILE1] [FIOLE2]', 40) . "Copy specified files to remote server.\n";
    $response .= str_pad('remote_rm [FILE1] [FILE2]', 40) . "Delete specified files / directories from remote server.\n";
    $response .= str_pad('remote_save TYPE PACKAGE:[PARENT:]ALIAS', 40) . "Save a component to the remote server.\n";
    $response .= str_pad('remote_delete TYPE PACKAGE:[PARENT:]ALIAS', 40) . "Delete a component from the remote server.\n";
    $response .= str_pad('remote_sql SQL', 40) . "Execute a SQL statement on the remote server.\n";
    $response .= str_pad('remote_scan PACKAGE', 40) . "Scan a package configuration file on the remote server.\n";
