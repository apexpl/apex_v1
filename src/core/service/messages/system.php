...
namespace apex\core\service\messages;

use apex\app;
use apex\svc\components;
use apex\core\service\messages;


/**
 * Handles the system messages, such as 
 * 2FA authentication e-mails, etc.
 */
class system extends messages
{
